...
public class NewsScreen {
    ...
    public ViewInteraction lastNews = onView(withIndex(withId(R.id.news_item_title_text_view), 7));
    public ViewInteraction firstNewsAgain = onView(withIndex(withId(R.id.news_item_title_text_view), 0));
    public ViewInteraction lastNewsAgain = onView(withIndex(withId(R.id.news_item_title_text_view), 7));
